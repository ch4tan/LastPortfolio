...
const Navbar = () => {
    const navContainerStyle = "flex flex-row w-96 h-12 bg-black items-center justify-center text-white rounded-br-xl rounded-xl gap-7 border-b border-r border-solid border-white";
